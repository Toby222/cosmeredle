...
}:
{
  ...
  "aberdeen@1.20.0" = fetchurl {
    url = "https://registry.npmjs.org/aberdeen/-/aberdeen-1.20.0.tgz";
    hash = "sha512-4jAGV5Lmz0ai5X8f24Pw6ZmneNaCKZ/TrUxRa+tp8XcLBq+aA2symoeUGPsC1JiGQQWd+xE1CoAjObw5HCK4iw==";
  };
